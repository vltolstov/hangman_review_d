...
23. Этот код делает слишком много всего: проверяет является ли буква корректной в контексте, добавляет букву, выводи сообщение о том, правильная ли буква, увеличивает количество ошибок, снова вывод сообщение. Это всё надо выносить в отдельные методы. Читай чистый код: глава 3
